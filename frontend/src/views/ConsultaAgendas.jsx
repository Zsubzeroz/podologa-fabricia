        ...
        <div style={{padding: '20px'}}>
           <div style={{display: 'flex', gap: '15px', flexWrap: 'wrap'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '5px'}}>
                 <label style={{fontSize: '13px', color: '#666', fontWeight: 'bold'}}>Intervalo do Período</label>
                 <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                    <input type="text" className="form-control" defaultValue="01/04/2026" style={{width: '120px'}} />
                    <span style={{color: '#999'}}>até</span>
                    <input type="text" className="form-control" defaultValue="30/04/2026" style={{width: '120px'}} />
                 </div>
              </div>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '5px', flex: 1}}>
                 ...
                 <div className="input-group">
                    ...
                    <button className="btn btn-warning" style={{background: '#f0ad4e', border: 'none', borderRadius: '0 3px 3px 0', color: 'white'}}>✖</button>
                 </div>
              </div>

              <div style={{display: 'flex', flexDirection: 'column', gap: '5px'}}>
                 <label style={{fontSize: '13px', color: '#666', fontWeight: 'bold'}}>Funcionário</label>
                 <select className="form-control" style={{width: '200px'}}>
                    <option>Fabricia Rodrigues Per</option>
                 </select>
              </div>

              <div style={{display: 'flex', flexDirection: 'column', gap: '5px'}}>
                 <label style={{fontSize: '13px', color: '#666', fontWeight: 'bold'}}>Status</label>
              ...
              <div style={{display: 'flex', alignItems: 'flex-end'}}>
                 <button className="btn btn-primary" style={{backgroundColor: '#9b59b6', borderColor: '#8e44ad', fontWeight: 'bold'}}>▼ FILTRO AVANÇADO</button>
              </div>
