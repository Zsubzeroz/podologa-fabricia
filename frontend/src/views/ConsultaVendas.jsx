      ...
      <div className="card" style={{border: '1px solid #e0e6ed', borderRadius: '3px', background: 'white', overflow: 'hidden'}}>
        ...
        <div style={{padding: '20px'}}>
           ...
           <div style={{marginTop: '15px'}}>
             <label style={{display: 'flex', alignItems: 'center', gap: '8px', color: '#666', fontSize: '13px'}}>
               <input type="checkbox" defaultChecked /> Considerar comissão de pacotes conforme data de pagamento
             </label>
           </div>
