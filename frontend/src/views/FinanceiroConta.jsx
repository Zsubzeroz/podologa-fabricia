export default function FinanceiroConta() {
  const contas = [
    { nome: 'Faculdade', saldo: '500,00' },
    { nome: 'Fátima', saldo: '500,00' },
    { nome: 'Internet casa', saldo: '100,00' },
    { nome: 'internet celular', saldo: '150,00' },
    { nome: 'Pilates', saldo: '220,00' },
  ];
    ...
    <div>
      ...
      <div style={{padding: '20px'}}>
        <div style={{display: 'flex', gap: '15px', marginBottom: '20px', alignItems: 'center'}}>
          <button className="btn btn-primary" style={{backgroundColor: '#3fa9f5'}}>+ NOVA CONTA</button>
          ...
          <div style={{display: 'flex'}}>
             ...
             <div style={{background: '#f5f5f5', border: '1px solid #ccc', borderLeft: 'none', padding: '5px 10px', fontSize: '13px', borderRadius: '0 3px 3px 0'}}>5 conta(s)</div>
          </div>
        </div>
        ...
        <table className="sa-table">
          <thead>
            <tr>
              <th style={{width: '30%'}}>NOME DA CONTA</th>
              <th>TIPO</th>
              <th>IMAGEM</th>
              <th>SALDO INICIAL</th>
              <th>STATUS</th>
          ...
          <tbody>
            {contas.map((c, i) => (
              <tr key={i}>
                ...
                <td style={{color: '#337ab7'}}>Conta Corrente</td>
                <td><div style={{fontSize: '18px'}}>💰</div></td>
                <td style={{color: '#337ab7'}}>{c.saldo}</td>
