...
export default function Anamnese() {
  const fichas = [
    ...
    { nome: 'ANAMNESE DADOS LAMINAR (PODOLOGIA)' },
    { nome: 'DIAGNÓSTICO' },
    { nome: 'EVOLUÇÃO' },
    { nome: 'Exame Físico' },
  ];
  ...
  return (
    <div>
      <div className="sa-page-header">
        <h2 className="sa-page-title">ANAMNESE, FICHA E CONTRATO</h2>
      </div>
      
      <div style={{padding: '20px'}}>
        <div style={{display: 'flex', gap: '15px', marginBottom: '20px', alignItems: 'center'}}>
          <button className="btn btn-primary" style={{backgroundColor: '#3fa9f5'}}>+ NOVA FICHA OU CONTRATO</button>
          ...
          <div style={{display: 'flex'}}>
             ...
             <div style={{background: '#f5f5f5', border: '1px solid #ccc', borderLeft: 'none', padding: '5px 10px', fontSize: '13px', borderRadius: '0 3px 3px 0'}}>6 ficha(s)</div>
          </div>
        </div>
        ...
        <table className="sa-table">
          <thead>
            <tr>
              <th>NOME DA ANAMNESE, FICHA E CONTRATO</th>
              <th>STATUS</th>
              <th>AÇÕES</th>
            </tr>
          </thead>
        ...
        <div style={{display: 'flex', gap: '10px', marginTop: '20px', alignItems: 'center'}}>
           ...
           <div style={{display: 'flex', border: '1px solid #ccc', borderRadius: '3px', background: 'white'}}>
              <button style={{padding: '5px 10px', border: 'none', background: 'transparent', cursor: 'pointer', borderRight: '1px solid #ccc'}}>«</button>
              <button style={{padding: '5px 10px', border: 'none', background: 'transparent', cursor: 'pointer', borderRight: '1px solid #ccc'}}>«</button>
              <button style={{padding: '5px 10px', border: 'none', background: '#e6e6e6', cursor: 'pointer', borderRight: '1px solid #ccc'}}>1</button>
              <button style={{padding: '5px 10px', border: 'none', background: 'transparent', cursor: 'pointer', borderRight: '1px solid #ccc'}}>»</button>
              <button style={{padding: '5px 10px', border: 'none', background: 'transparent', cursor: 'pointer'}}>»</button>
           </div>
        </div>
